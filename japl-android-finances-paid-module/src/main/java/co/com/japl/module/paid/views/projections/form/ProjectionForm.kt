...
import co.com.japl.module.paid.views.projections.form.fakes.FakeProjectionFormPort
...
@RequiresApi(Build.VERSION_CODES.S)
@Composable
private fun Scaffold(viewModel: ProjectionFormViewModel, navController: NavController) {
...
private fun ProjectionFormPreviewLight() {
    val projectionSvc: IProjectionFormPort = FakeProjectionFormPort()
    MaterialThemeComposeUI {
        ProjectionForm(
            viewModel(
                factory = ProjectionFormViewModel.Companion.create(
                    extras = viewModel(),
