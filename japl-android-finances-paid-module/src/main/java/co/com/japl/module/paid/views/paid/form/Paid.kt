...
private fun Body(viewModel: PaidViewModel, navController: NavController) {
    ...
    Scaffold(floatingActionButton = {
        Buttons(
            add = { viewModel.save(navController, context) },
...
@Composable
private fun Form(viewModel: PaidViewModel, modifier: Modifier) {
    val account = remember { viewModel.account }
    val accountError = remember { viewModel.errorAccount }
    val accountList = remember { viewModel.accountListPair }
    val datePaidState = remember { viewModel.date }
    val errorDatePaidState = remember { viewModel.errorDate }
    val nameItemState = remember { viewModel.name }
    val errorNameItemState = remember { viewModel.errorName }
    val valueItemState = remember { viewModel.value }
    val errorValueItemState = remember { viewModel.errorValue }
    ...
    Column(modifier = modifier.padding(Dimensions.PADDING_SHORT)) {
        ...
        CheckBoxField(
            title = stringResource(id = R.string.recurrent),
