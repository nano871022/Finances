...
import co.com.japl.module.credit.views.ListSimulator
...
class ListSave : Fragment() {
    ...
    private val viewModel: SimulatorListViewModel by viewModels{
        ViewModelFactory (
            owner = this,
            viewModelClass = SimulatorListViewModel::class.java,
            build = {
